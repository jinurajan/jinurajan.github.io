		    ...
		    <header>
		        <div class="bio-header clearfix">
		            <div class="col_half first">
		                <h1 class="bio-title"><?php if ($bio_name == '') { ?>Jinu Rajan<?php } else { ?><?php echo $bio_name ?><?php } ?></h1>
		            ...
		            <div class="col_half clearfix">
		                ...
		                <div class="bio-image">
							...
							if(has_post_thumbnail()): echo '<img src="'.$thumbnail[0].'" alt="'. $bio_name .'"/>'; else: ?><img src="<?php bloginfo('template_url'); ?>/images/bio_image.jpg" alt="Jinu Rajan" />
							<?php endif; ?>
		                </div>
		                <div class="bio-info">
